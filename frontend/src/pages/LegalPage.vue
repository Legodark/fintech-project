...
Identidad: FINSAVE
Domicilio social: Calle Moon N24
CIF: B154896547
Teléfono: 612 321 123
Correo Electrónico: test@test.com
Contacto: MONEY
Nombre del dominio: https://www.finsave.com
...
Remitir periódicamente comunicaciones sobre servicios, eventos y noticias relacionadas con las actividades desarrolladas por FINSAVE, por cualquier medio (teléfono, correo postal o email), salvo que se indique lo contrario o el usuario se oponga o revoque su consentimiento.
...
Derivada de las finalidades antes mencionadas, en FINSAVE gestionamos las siguientes categorías de datos:

Datos identificativos
Metadatos de comunicaciones electrónicas
Datos de información comercial. En caso de que el usuario facilite datos de terceros, manifiesta contar con el consentimiento de estos y se compromete a trasladarle la información contenida en esta cláusula, eximiendo a FINSAVE de cualquier responsabilidad en este sentido.
No obstante, FINSAVE podrá llevar a cabo las verificaciones para constatar este hecho, adoptando las medidas de diligencia debida que correspondan, conforme a la normativa de protección de datos.
...
Por último, los datos se podrán utilizar para dar cumplimiento a las obligaciones legales aplicables a FINSAVE
...
Tus datos podrán ser accedidos por aquellos proveedores que prestan servicios a FINSAVE, tales como servicios de alojamiento, herramientas de marketing y sistemas de contenido u otros profesionales, cuando dicha comunicación sea necesaria normativamente, o para la ejecución de los servicios contratados.

FINSAVE, ha suscrito los correspondientes contratos de encargo de tratamiento con cada uno de los proveedores que prestan servicios a FINSAVE, con el objetivo de garantizar que dichos proveedores tratarán tus datos de conformidad con lo establecido en la legislación vigente.
...
Encriptación de las comunicaciones entre el dispositivo del usuario y los servidores de FINSAVE
Encriptación de la información en los propios servidores de FINSAVE
Otras medidas que eviten el acceso a los datos del usuario por parte de terceros.
En aquellos casos en los que FINSAVE cuente con prestadores de servicio para el mantenimiento de la plataforma que se encuentren fuera de la Unión Europea, estas trasferencias internacionales se hayan regularizadas atendiendo al compromiso de FINSAVE con la protección, integridad y seguridad de los datos personales de los usuarios.
Derechos – ¿Cuáles son tus derechos cuando nos facilitas tus datos y cómo puedes ejercerlos?
Tienes derecho a obtener confirmación sobre si en FINSAVE estamos tratando datos personales que te conciernan, o no.
...
En determinadas circunstancias y por motivos relacionados con tu situación particular, podrás oponerte al tratamiento de tus datos. FINSAVE dejará de tratar los datos, salvo por motivos legítimos imperiosos, o el ejercicio o la defensa de posibles reclamaciones.
...
Si deseas hacer uso de cualquiera de tus derechos puede dirigirse a test@test.com.
...
FINSAVE podrá modificar la presente Política de Privacidad en cualquier momento, siendo publicadas las sucesivas versiones en el Sitio Web. En cualquier caso, FINSAVE comunicará con previo aviso las modificaciones de la presente política que afecten a los usuarios a fin de que puedan aceptar las mismas.

La presente Política de Privacidad se encuentra actualizada a fecha 27/12/2018 FINSAVE (España). Reservados todos los derechos.
